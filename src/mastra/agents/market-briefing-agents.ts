...
function createModel(config?: ResolvedAiModelConfig) {
...
export function createGlobalMarketScoutAgent(config?: ResolvedAiModelConfig) {
  return new Agent({
...
export function createFinanceNewsAnalystAgent(config?: ResolvedAiModelConfig) {
  return new Agent({
...
export function createDailyBriefingCoordinatorAgent(config?: ResolvedAiModelConfig) {
  return new Agent({
...
export const globalMarketScoutAgent = createGlobalMarketScoutAgent();
export const financeNewsAnalystAgent = createFinanceNewsAnalystAgent();
export const dailyBriefingCoordinatorAgent = createDailyBriefingCoordinatorAgent();
